...
**eXuis ** ist eine minimalistische, Turing-vollständige Programmiersprache. Der gesamte Zustand der Maschine besteht aus genau zwei Zahlen — **A** und **B** — sowie einem Stack. Alles andere wird durch das Definieren eigener Wörter aufgebaut.

🌐 **[Playground öffnen](https://klingforth.github.io/eXuis-play/)**
...
Wörter können andere Wörter aufrufen und sich selbst rekursiv aufrufen — das ist die einzige Schleife die eXuis  braucht.
...
- **💾 POOL** — alle aktuellen Wörter speichern → `eXuis.pool`
...
Der Name kommt von *Equilibrium* — Gleichgewicht. Zwei Pole, die sich beeinflussen. Die einzige Frage die eXuis stellt: **ist hier noch etwas?** (`?` prüft auf Null). Alles andere — Schleifen, Vergleiche, Datenstrukturen — entsteht durch das Kombinieren einfacher Wörter.

eXuis ist Turing-vollständig durch:
- Unbegrenzter Stack
- Bedingte Ausführung (`?`)
- Rekursive Wörter
...
- Vollständiger eXuis-Interpreter in JavaScript
...
*eXuis — by Patrick Klingforth (Rick)*
